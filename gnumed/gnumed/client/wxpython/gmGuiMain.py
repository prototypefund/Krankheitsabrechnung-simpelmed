...
"""
SimpelMed Haupt-Menu

Original-Autoren
H. Herb <hherb@gnumed.net>
...
#		self.Bind(wx.EVT_MENU, self.__on_configure_freediams_cmd, item)
        ...
        self.mainmenu.Append(menu_gnumed, '&SimpelMed')
...
class gmApp(wx.App):
    ...
    def OnInit(self):
        ...
        #input("gmGuiMain vor Sprung zum Anmeldefenster 3454")

        # Mit Aufruf der Funktion __establish_backend_connection()
        # erscheint das »Anmeldefenster« / »Arbeitsplatz GNUmed Default«
        if not self.__establish_backend_connection():
            return False
        #input("gmGuiMain nach Anmeldefenster 3460")
        
        if not self.__verify_db_account():
            return False
        #input("gmGuiMain 3464")
        if not self.__verify_praxis_branch():
            return False
        #input("gmGuiMain 3467")
...
#				print("User was inactive for 30 seconds.")
    ...
    def __establish_backend_connection(self):
        ...
        from Gnumed.wxpython import gmAuthWidgets
        # Hier erscheint das »Anmeldefenster«
        ...
        if connected:
            #input("connected erfolgreich nach Anmeldefenster ggm 3641")
            return True
...
def main():
    ...
    #input("gmGuiMain 3992")

    setup_safe_wxEndBusyCursor()
    #input("gmGuiMain 3995")

    setup_callbacks()
    #input("gmGuiMain 3998")
